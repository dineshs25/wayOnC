...
export const pagesItems = [
  {
    title: "Equity",
    subItems: [
      { title: "Cash", link: "/services/equity/Cash" },
      { title: "Option", link: "/services/equity/Option" },
      { title: "Delivery", link: "/services/equity/Delivery" },
      { title: "Index", link: "/services/equity/Index" },
      { title: "Future", link: "/services/equity/Future" },
      { title: "Stock + Index Option", link: "/services/equity/StockIndex" },
    ],
  },
  {
    title: "Mcx",
    subItems: [
      { title: "Normal Mcx", link: "/services/mcx/NormalMcx" },
      { title: "Bullions", link: "/services/mcx/Bullions" },
      { title: "Energy", link: "/services/mcx/Energy" },
      { title: "Metal", link: "/services/mcx/Metal" },
      { title: "Mcx Option", link: "/services/mcx/McxOption" },
    ],
  },
  {
    title: "NcDex",
    subItems: [
      { title: "Normal Ncdex", link: "/services/ncdex/Ncdex" },
...
export const resources = [
  ...
  { name: "Investor Charter", link: "/investor-chartor" },
