export const intradayTradingData = {
    ...
    "body":[
        ...
        "<p>With so many stocks to choose from, a myriad of news and data- how can one make sense out of it all and use it to consistently grow one’s capital? The answer is simple- Shyam Advisory’s Intraday Trading Tips Site.</p>",
        ...
        "<h6>The Shyam Advisory® Intraday Trading Approach</h6>",
        "<p>At Shyam Advisory®, we base our picks based on a mix of qualitative and quantitative analysis. The key points of our strategy in sending you the best intraday tips are discussed ahead.</p>",
...
export const ShareMarket = {
    ...
    "body":[
        ...
        "<p>At Shyam Advisory, we take the responsibility of effort and wise judgment upon ourselves and suggest the stocks to the clients which stand at a high chance of making a profit.</p>",
...
export const Commodity = {
    ...
    "body":[
        ...
        "<p>However, for the lone investor, learning how commodities move, what to track and what to ignore, and how to make sense of the plethora of data out there- all this can be a daunting task. Shyam Advisory takes care of all that and provides you with the most accurate of commodity trading tips that will help your investment to grow.</p>",
       
        "<h6>The Shyam Advisory Advantage</h6>",
...
export const mcxOptons = {
    ...
    "body":[
        ...
        "<p>Our Options Tips service is intended for traders with a trading lot capacity of 1 or 2 lots. Whether you are a beginner in trading or a veteran with years of experience trading commodities, you can benefit from the Shyam Advisory Options Tips service.</p>",
        ...
        "<p>The commodity market is filled with several trader tips service providers, but not all of them are trustworthy. It is crucial for one to find a credible MCX Option Tips advisory that can provide them with genuine MCX Options tips and ensure a substantial profit in a short time. Shyam Advisory is one such MCX Option Tips provider</p>",
        ...
        "<p>MCX Option Tips with Shyam Advisory</p>",
        "<p>Shyam Advisory will teach you a variety of different MCX Option strategies that can maximize your investments for the best results. With more than a decade of experience and training, our experts can help you use those strategies based on your needs</p>",
        ...
        "<h6>What are the benefits of Option Tips from Shyam Advisory?</h6>",
        ...
        "<p>At Shyam Advisory, we want to help you along your trading journey. We share our expert tips on Options to teach you about the sector. Our Commodity Options tips will help guide your trade and keep you updated with all of the latest information. For the best Options, there is no better partner that you can connect with than us.</p>",
        ...
        "<p>Reach out to us at 0281 619 9999 or fill out the inquiry form to learn more about the MCX Option tips from Shyam Advisory.</p>"
    ] 
}
export const refundPolicy = {
    "title":"Refund Policy",
    "body":[
        "<p>Customer satisfaction is important to us at Shyam Advisory – Investment Advisor.</p>",
        "<p>All services offered by Shyam Advisory limited is subject to the terms and conditions and clauses mentioned in agreement signed in between client and Shyam Advisory-Investment Adviser.</p>",
...
export const disclaimer = {
    "title":"Disclaimer",
    "body":[
        "<p>Shyam Advisory – Investment Advisor Limited, its directors, servants and/or agents shall not, be responsible or liable for the economic performance of your portfolio or for any losses, claims, costs or expenses as a result of the performance of our obligations to you an advisory client and for any losses / damages suffered due to the market fluctuation.</p>",
        "<p>M/s. Shyam Advisory – Investment Advisor Ltd or its related companies or their directors or employees do not give any warranty, make any representation as to, or accept responsibility for, its accuracy, reliability, timelines or completeness now or in the future. While the information provided by M/s. Shyam Advisory Ltd is believed to be accurate, Shyam Advisory does not accept responsibility for any inaccuracy or any actions taken upon reliance with the information on this site.</p>",
        "<p>Shyam Advisory – Investment Advisor reserves the right to make modifications and alterations in the material contained at this site without any intimation to you of such modifications.</p>",
        ...
        "<p>Shyam Advisory – Investment Advisor does not provide assured return in any of its services; Investors are advised to beware of such fraudulent calls.</p>",
...
export const privacyPolicy = {
    ...
    "body":[
        "<p>At Shyam Advisory – Investment Advisor we respect your privacy. To better protect your privacy we provide this notice explaining our online information practices and the choices you can make about the way your information is collected and used.</p>",
...
export const termsAndConditions = {
    ...
    "body":[
        "<p>This Website is designed, developed and maintained by Shyam Advisory – Investment Advisor.</p>",
        ...
        "<p>On filling and submitting any form in Shyam Advisory website, you will authorize an Executive of Shyam Advisory to call you even if your number is registered under Do Not Call registration.</p>",
        "<p>Shyam Advisory – Investment Advisor may revise the Terms of Use at any time without notice.</p>",
